...
ActiveRecord::Schema.define(version: 2019_05_05_142006) do
  ...
  create_table "open_trips", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "price"
    t.bigint "user_id"
    t.bigint "trip_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["trip_id"], name: "index_open_trips_on_trip_id"
    t.index ["user_id"], name: "index_open_trips_on_user_id"
  end
  ...
  add_foreign_key "open_trips", "trips"
  add_foreign_key "open_trips", "users"
